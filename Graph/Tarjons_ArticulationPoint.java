...
public class Tarjons_ArticulationPoint {
    static class Edge{
        int src,dest;
    ...
    public static void dfs(ArrayList<Edge> graph[], int curr, int par,boolean vis[], int dt[], int low[], int time,boolean isArticulation[]) {
        vis[curr] = true;   
